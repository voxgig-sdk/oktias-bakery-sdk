...
// OktiasBakery SDK utility type

class OktiasBakeryUtility
{
    ...
    public static function copy(OktiasBakeryUtility $src): OktiasBakeryUtility
    {
        $u = new OktiasBakeryUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
