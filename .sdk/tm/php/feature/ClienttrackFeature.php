...
// OktiasBakery SDK clienttrack feature
...
class OktiasBakeryClienttrackFeature extends OktiasBakeryBaseFeature
{
    ...
    public function PostConstruct(OktiasBakeryContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OktiasBakery-SDK';
