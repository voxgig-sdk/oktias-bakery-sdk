...
// OktiasBakery SDK utility: fetcher

class OktiasBakeryFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OktiasBakerySDK/1.0)';
    ...
    public static function call(OktiasBakeryContext $ctx, string $fullurl, array $fetchdef): array
    {
