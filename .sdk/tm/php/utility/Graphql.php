...
// OktiasBakery SDK utility: graphql
//
...
class OktiasBakeryGraphql
{
    ...
    // equivalent.
    public static function body(OktiasBakeryContext $ctx): mixed
    {
    ...
    public static function errors(OktiasBakeryContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
