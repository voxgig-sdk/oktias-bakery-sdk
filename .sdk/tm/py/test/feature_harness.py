# OktiasBakery SDK feature test harness
#
...
class _Ctx:
    ...
    def __init__(self, client, utility, op=None, entity=None, ctrl=None):
        ...
        self.out = {}
        self.ctrl = ctrl if ctrl is not None else OktiasBakeryControl()
        self.meta = {}
        self.op = op
        self.entity = entity
...
class Harness:
    ...
    def op(self, op="load", entity="widget", method=None, path=None,
        ...
        ctx = _Ctx(self.client, self.utility,
                   ...
                   ctrl=OktiasBakeryControl(ctrl or {}))
