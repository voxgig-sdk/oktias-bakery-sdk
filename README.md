...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/oktias-bakery` | `npm install @voxgig-sdk/oktias-bakery` |
| Python | `voxgig-sdk-oktias-bakery` | `pip install voxgig-sdk-oktias-bakery` |
| PHP | `voxgig-sdk/oktias-bakery` | `composer require voxgig-sdk/oktias-bakery` |
| Golang | `github.com/voxgig-sdk/oktias-bakery-sdk/go` | `go get github.com/voxgig-sdk/oktias-bakery-sdk/go` |
| Ruby | `voxgig-sdk-oktias-bakery` | `gem install voxgig-sdk-oktias-bakery` |
| Lua | `voxgig-sdk-oktias-bakery` | `luarocks install voxgig-sdk-oktias-bakery` |
