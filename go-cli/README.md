...
AQL-driven CLI and REPL for the OktiasBakery SDK. Positional arguments are
...
./oktias-bakery-cli load 1 product
./oktias-bakery-cli load '{id:1}' product
