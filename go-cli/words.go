...
func registerSDKWords(r *eng.Registry, client *sdk.OktiasBakerySDK) {
...
func runOp(client *sdk.OktiasBakerySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
