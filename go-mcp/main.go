// Command OktiasBakery-mcp is an MCP server exposing the OktiasBakery
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OktiasBakery_list  — list records of an entity
//	OktiasBakery_load  — load a single record of an entity
//
