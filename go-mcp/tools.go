...
func registerTools(server *mcp.Server, client *sdk.OktiasBakerySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "oktias-bakery_list",
		Description: "List records from OktiasBakery. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "oktias-bakery_load",
		Description: "Load a single record from OktiasBakery. " +
...
func runOp(client *sdk.OktiasBakerySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OktiasBakerySDK, name string) (sdk.OktiasBakeryEntity, error) {
