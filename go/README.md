# OktiasBakery Golang SDK



The Golang SDK for the OktiasBakery API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/oktias-bakery-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/oktias-bakery-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/oktias-bakery-sdk/go=../oktias-bakery-sdk/go
```
...
import (
    "fmt"
    sdk "github.com/voxgig-sdk/oktias-bakery-sdk/go"
)
...
```go
func NewOktiasBakerySDK(options map[string]any) *OktiasBakerySDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OktiasBakerySDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### OktiasBakerySDK methods
...
| `Product` | `(data map[string]any) OktiasBakeryEntity` | Create a Product entity instance. |

### Entity interface (OktiasBakeryEntity)

All entities implement the `OktiasBakeryEntity` interface.
...
```
github.com/voxgig-sdk/oktias-bakery-sdk/go/
├── oktias-bakery.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/oktias-bakery-sdk/go`) re-exports everything needed
