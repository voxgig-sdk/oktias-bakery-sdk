# OktiasBakery Golang SDK Reference

Complete API reference for the OktiasBakery Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *OktiasBakerySDK`
...
#### `Product(data map[string]any) OktiasBakeryEntity`
...
| `price` | `float64` | Yes | Price of the product |
