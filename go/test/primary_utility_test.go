...
func TestPrimaryUtility(t *testing.T) {
	...
	t.Run("fetcher-live", func(t *testing.T) {
		...
		liveClient := sdk.NewOktiasBakerySDK(map[string]any{
	...
	t.Run("fetcher-blocked-test-mode", func(t *testing.T) {
		...
		blockedClient := sdk.NewOktiasBakerySDK(map[string]any{
			"base": "http://localhost:8080",
			"system": map[string]any{
				"fetch": func(url string, fetchdef map[string]any) (map[string]any, error) {
	...
	t.Run("makePoint-basic", func(t *testing.T) {
		runsetNamed(t, "makePoint", getSpec(primary, "makePoint", "basic"), func(entry map[string]any) (any, error) {
			...
			if err != nil {
				var sdkErr *sdk.OktiasBakeryError
...
func makeTestCtx(client *sdk.OktiasBakerySDK, utility *sdk.Utility, overrides map[string]any) *sdk.Context {
	ctxmap := map[string]any{
		"opname":  "load",
		"client":  client,
		"utility": utility,
...
func makeTestFullCtx(client *sdk.OktiasBakerySDK, utility *sdk.Utility) *sdk.Context {
	ctx := makeTestCtx(client, utility, nil)
