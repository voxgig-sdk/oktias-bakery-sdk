# OktiasBakery PHP SDK



The PHP SDK for the OktiasBakery API — an entity-oriented client using PHP conventions.
...
```php
require_once 'oktiasbakery_sdk.php';
$client = new OktiasBakerySDK($options);
```
...
```
php/
├── oktiasbakery_sdk.php          -- Main SDK class
...
The main class (`oktiasbakery_sdk.php`) exports the SDK class
