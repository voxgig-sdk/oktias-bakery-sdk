...
// OktiasBakery SDK audit feature
...
class OktiasBakeryAuditFeature extends OktiasBakeryBaseFeature
{
    ...
    private function _emit(OktiasBakeryContext $ctx, string $outcome): void
    {
