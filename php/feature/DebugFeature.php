...
// OktiasBakery SDK debug feature
...
class OktiasBakeryDebugFeature extends OktiasBakeryBaseFeature
{
    ...
    private function _finish(OktiasBakeryContext $ctx, bool $ok): void
    {
