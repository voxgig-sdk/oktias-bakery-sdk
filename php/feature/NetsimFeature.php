...
// OktiasBakery SDK netsim feature
...
class OktiasBakeryNetsimFeature extends OktiasBakeryBaseFeature
{
    ...
    private function _simulate(OktiasBakeryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OktiasBakeryContext $ctx, array $applied): void
    {
        $client = $this->client;
