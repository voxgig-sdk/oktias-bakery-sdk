...
// OktiasBakery SDK proxy feature
...
class OktiasBakeryProxyFeature extends OktiasBakeryBaseFeature
{
    ...
    public function init(OktiasBakeryContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OktiasBakeryContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
