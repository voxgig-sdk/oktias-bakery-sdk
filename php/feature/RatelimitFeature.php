...
// OktiasBakery SDK ratelimit feature
...
class OktiasBakeryRatelimitFeature extends OktiasBakeryBaseFeature
{
    ...
    private function _acquire(OktiasBakeryContext $ctx): void
    {
    ...
    private function _track(OktiasBakeryContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
