...
class OktiasBakeryRbacFeature extends OktiasBakeryBaseFeature
{
    ...
    private function _required(OktiasBakeryContext $ctx): ?string
    {
    ...
    private function _reject(OktiasBakeryContext $ctx, string $required): void
    {
    ...
    private function _track(OktiasBakeryContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
