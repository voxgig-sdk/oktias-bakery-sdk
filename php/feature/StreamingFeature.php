...
// OktiasBakery SDK streaming feature
...
class OktiasBakeryStreamingFeature extends OktiasBakeryBaseFeature
{
    ...
    private function _iterate(OktiasBakeryResult $result): \Generator
    {
    ...
    private function _streamable(OktiasBakeryContext $ctx): bool
    {
