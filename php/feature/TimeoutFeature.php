...
// OktiasBakery SDK timeout feature
...
class OktiasBakeryTimeoutFeature extends OktiasBakeryBaseFeature
{
    ...
    private function _with_timeout(OktiasBakeryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OktiasBakeryContext $_ctx, float $ms): void
    {
        $client = $this->client;
