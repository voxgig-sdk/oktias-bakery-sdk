...
// OktiasBakery SDK pipeline test
//
...
{
    private static function utility(): OktiasBakeryUtility
    {
        return new OktiasBakeryUtility();
    }
    ...
    private static function ctx(array $over = []): OktiasBakeryContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new OktiasBakeryContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new OktiasBakeryOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof OktiasBakeryError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new OktiasBakeryOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = OktiasBakeryMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new OktiasBakeryOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = OktiasBakeryMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new OktiasBakeryOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = OktiasBakeryMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OktiasBakerySpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = OktiasBakeryMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new OktiasBakeryResponse([]),
            'result' => new OktiasBakeryResult([]),
        ]);
        [, $err] = OktiasBakeryMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new OktiasBakerySpec([]),
            'response' => null,
            'result' => new OktiasBakeryResult([]),
        ]);
        [, $err] = OktiasBakeryMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new OktiasBakerySpec(['step' => 's']),
            'response' => new OktiasBakeryResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new OktiasBakeryResult([]),
        ]);
        [, $err] = OktiasBakeryMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new OktiasBakerySpec(['step' => 's']),
            'response' => new OktiasBakeryResponse(self::resp(200, ['v' => 1])),
            'result' => new OktiasBakeryResult([]),
        ]);
        [, $err] = OktiasBakeryMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new OktiasBakerySpec(['step' => 's']),
            'response' => new OktiasBakeryResponse(self::resp(200, ['v' => 2])),
            'result' => new OktiasBakeryResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        OktiasBakeryMakeResponse::call($ctx);
    ...
    {
        $preset = new OktiasBakeryResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new OktiasBakerySpec([]),
            'response' => new OktiasBakeryResponse([]),
            'result' => new OktiasBakeryResult([]),
        ...
        [$got, $err] = OktiasBakeryMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new OktiasBakeryResult([])]);
        [, $err] = OktiasBakeryMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new OktiasBakerySpec([]), 'result' => null]);
        [, $err] = OktiasBakeryMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OktiasBakerySpec(['step' => 's']),
            'result' => new OktiasBakeryResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new OktiasBakeryOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OktiasBakeryMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OktiasBakerySpec(['step' => 's']),
            'result' => new OktiasBakeryResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new OktiasBakeryOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OktiasBakeryMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OktiasBakeryResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new OktiasBakerySpec([]),
            'result' => new OktiasBakeryResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = OktiasBakeryMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OktiasBakeryMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new OktiasBakeryError('boom', 'boom');
        $utility->fetcher = function (OktiasBakeryContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OktiasBakerySpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = OktiasBakeryMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (OktiasBakeryContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = OktiasBakeryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(OktiasBakeryResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        OktiasBakeryMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (OktiasBakeryContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OktiasBakerySpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = OktiasBakeryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new OktiasBakeryResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new OktiasBakerySpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = OktiasBakeryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = OktiasBakeryMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = OktiasBakeryMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new OktiasBakeryResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, OktiasBakeryDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new OktiasBakeryResult(['ok' => false])]);
        $this->expectException(OktiasBakeryError::class);
        OktiasBakeryDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new OktiasBakeryResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', OktiasBakeryMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        OktiasBakeryMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new OktiasBakeryBaseFeature();
        $b = new OktiasBakeryBaseFeature();
        OktiasBakeryFeatureAdd::call($ctx, $a);
        OktiasBakeryFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): OktiasBakeryBaseFeature
    {
        $f = new OktiasBakeryBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        OktiasBakeryFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): OktiasBakeryContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new OktiasBakerySpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OktiasBakeryPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        OktiasBakeryPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new OktiasBakeryResponse(['headers' => null]),
            'result' => new OktiasBakeryResult([]),
        ]);
        OktiasBakeryResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        OktiasBakeryResultBody::call($ctx);
