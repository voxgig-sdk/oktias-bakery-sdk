...
// OktiasBakery SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OktiasBakerySDK::test)
...
{
    private const SDK_CLASS = 'OktiasBakerySDK';
    ...
    private const SDK_BASE = 'oktiasbakery_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../oktiasbakery_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
