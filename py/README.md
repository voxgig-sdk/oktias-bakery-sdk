# OktiasBakery Python SDK



The Python SDK for the OktiasBakery API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/oktias-bakery-sdk/releases)) or
...
```
py/
├── oktiasbakery_sdk.py         -- Main SDK module
