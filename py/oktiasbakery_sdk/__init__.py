...
from oktiasbakery_sdk.utility import register

# Load features
from oktiasbakery_sdk.feature.base_feature import OktiasBakeryBaseFeature
from oktiasbakery_sdk.features import _has_feature, _make_feature
...
class OktiasBakerySDK:
    ...
    def get_utility(self):
        return OktiasBakeryUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OktiasBakerySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Product(self, data=None) -> "ProductEntity":
        ...
        from oktiasbakery_sdk.entity.product_entity import ProductEntity
