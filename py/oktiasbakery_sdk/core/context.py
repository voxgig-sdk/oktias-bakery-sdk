...
from oktiasbakery_sdk.core.helpers import get_ctx_prop, to_map
...
class OktiasBakeryContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, OktiasBakerySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OktiasBakeryResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OktiasBakeryResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OktiasBakeryError(code, msg, self)
