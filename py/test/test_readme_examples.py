# OktiasBakery SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OktiasBakerySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OktiasBakerySDK(...) and OktiasBakerySDK.test(...) become
#      OktiasBakerySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "oktiasbakery_sdk"
_SDK_CLASS = "OktiasBakerySDK"
