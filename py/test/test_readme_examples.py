# OktiasBakery SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from oktiasbakery_sdk import OktiasBakerySDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"OktiasBakerySDK": OktiasBakerySDK, "os": os}
        try:
