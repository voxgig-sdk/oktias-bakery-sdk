...
#      offline in seeded test mode (OktiasBakerySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OktiasBakery_sdk.rb")
  SDK_CLASS = "OktiasBakerySDK"
