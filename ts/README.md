# OktiasBakery TypeScript SDK



The TypeScript SDK for the OktiasBakery API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Product()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `OktiasBakerySDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `OktiasBakerySDK.test(testopts?, sdkopts?)` | `OktiasBakerySDK` | Create a test-mode client. |
...
| `client` | `client(): OktiasBakerySDK` | Return the parent SDK client. |
...
oktias-bakery/
├── src/
│   ├── OktiasBakerySDK.ts        # Main SDK class
