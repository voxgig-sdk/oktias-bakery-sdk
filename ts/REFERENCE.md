# OktiasBakery TypeScript SDK Reference

Complete API reference for the OktiasBakery TypeScript SDK.
...
```ts
new OktiasBakerySDK(options?: object)
```
...
#### `OktiasBakerySDK.test(testopts?, sdkopts?)`
...
**Returns:** `OktiasBakerySDK` instance in test mode.
...
Alias for `OktiasBakerySDK.test()`.
...
Return the parent `OktiasBakerySDK` instance.
